...
$all_tags = array('A', 'B', 'C', 'D');

$data['head'] = array("id","title","firstname","lastname","website","phone","cellphone","birthdate","subscribed","tags");
$data['data'] = array();
$fn_cnt = count($first_names);
$ln_cnt = count($last_names);
$tld_cnt = count($tld);
$all_tags_cnt = count($all_tags);
...
for ($i = 1; $i <= 10000; $i++)
{
    ...
    $data['data'][] = array($i, $title, $first_name, $last_name, $website, $phone, $cellphone, $birthdate, $subscribed, $tags);
}
